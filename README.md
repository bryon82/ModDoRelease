...
* For the github release, this script will get the last change from the changelog to make the body of the release notes. The changelog is also included in the thunderstore package so for both packages you will need a changelog in the solution directory.  
